                    ...
                    <div className="max-w-2xl mx-auto">
                        ...
                        <div className="bg-white rounded-[40px] border border-slate-100 shadow-sm p-6 lg:p-8">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <div>
                                    <h3 className="text-lg font-playfair font-semibold text-slate-900">Account Security</h3>
                            ...
                            <div className="flex flex-wrap items-center gap-3 mt-6 pt-6 border-t border-slate-100">
                                <button
                                    ...
                                    disabled={isSaving}
                                    className="px-6 py-2.5 bg-slate-900 text-white rounded-full font-semibold hover:bg-slate-800 shadow-md active:scale-95 transition-all disabled:opacity-50"
                                >
                                    {isSaving ? 'Updating...' : 'Update Password'}
                                </button>
                                <button
                                    onClick={() => logout()}
                                    className="flex items-center gap-2 px-4 py-2.5 text-slate-600 hover:text-slate-900 rounded-full hover:bg-slate-50 transition-all"
                                >
