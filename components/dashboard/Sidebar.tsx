    ...
    switch (currentUserType) {
      ...
      case 'trainer':
        return [
          ...
          { icon: <Calendar className="w-5 h-5" />, label: 'Availability', href: '/dashboard/trainer/availability' },
      ...
      case 'admin':
        return [
          ...
          { icon: <Award className="w-5 h-5" />, label: 'Certificates', href: '/dashboard/admin/certificates' },
          { icon: <Calendar className="w-5 h-5" />, label: 'Reports', href: '/dashboard/admin/reports' },
